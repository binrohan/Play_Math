...
namespace PlayMath.API.MathEngine
{
    ...
    {
        public List<TrinomialSolutionDto> Qudratic(int a = 1, int b = 1, int c = 0, int d = 0)
        {
            ...
            int e = a * c;
            var factors = e.PrimeFactors();

            var pairFactor = AssitUtilities.MidTermFactorPair(factors, b, e);
